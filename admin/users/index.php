...
<html>
<head>
	<title>Users - Secure Prime Investment</title>
                                ...
                                <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) { 
                                            $sqlprofile = "SELECT * FROM users WHERE Username = '".$row['Username']."' ";
                                            $resultprofile = mysqli_query($conn, $sqlprofile);
                                            $rowprofile = mysqli_fetch_assoc($resultprofile);
                                            if (empty($rowprofile['Profile'])) {
                                                $picture_profile = "profiles/default.jpg";
                                            }else{
                                                $picture_profile = $rowprofile['Profile'];
                                            }
                                        ?>
                                        <tr>
                                            <td align="center"><img style="width: 50px; height: 50px;" class="img-circle" src="/SecurePrimeInvestment/user/<?= $picture_profile ?>" class="table-user-thumb" alt=""></td>
                                            ...
                                            <?php
                                            if ($rowprofile['Active'] == 1) { ?>
                                                <td>
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#blockModal<?php echo "" . $row['SN'] . ""; ?>">Block</button>
                                                    <a href="https://api.whatsapp.com/send?phone=237<?php echo "" . $row['Phone'] . ""; ?>" target="_blank">
                                                                    <button type="button" class="btn btn-info">Whatsapp</button>
                                                                </a>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#emailModal<?php echo "" . $row['SN'] . ""; ?>">Email</button>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal<?php echo "" . $row['SN'] . ""; ?>">Delete</button>
                                                </td>
                                            <?php }elseif ($rowprofile['Active'] == 0) { ?>
                                                <td>
                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#activateModal<?php echo "" . $row['SN'] . ""; ?>">Activate</button>
                                                    <a href="https://api.whatsapp.com/send?phone=237<?php echo "" . $row['Phone'] . ""; ?>" target="_blank">
                                                        <button type="button" class="btn btn-info">Whatsapp</button>
                                                    </a>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#emailModal<?php echo "" . $row['SN'] . ""; ?>">Email</button>
                                            ...
                                            <?php } ?>
                                                    ...
                                                    <div class="modal fade" id="blockModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="blockModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Block user account</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to block the account of <strong><?php echo "" . $row['Username'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="block.php?id=<?php echo "" . $row['Username'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="modal fade" id="activateModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="blockModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Activate user account</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-success">
                                                                        Are you sure you want to activate the account of <strong><?php echo "" . $row['Username'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="activate.php?id=<?php echo "" . $row['Username'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal fade" id="emailModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form class="forms-sample" action="email.php" method="POST">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="demoModalLabel">Send Email To <strong><?php echo "" . $row['Username'] . ""; ?></strong></h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <input type="hidden" name="member" class="form-control" id="exampleInputUsername2" value="<?php echo "" . $row['Email'] . ""; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <input type="text" name="subject" required class="form-control" id="exampleInputUsername2" placeholder="Subject">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <textarea name="message" required class="form-control" id="exampleInputUsername2" placeholder="Type your message here..."></textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" name="submit" class="btn btn-primary">SEND</button></a>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Delete user account</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to delete the account of <strong><?php echo "" . $row['Username'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="delete.php?id=<?php echo "" . $row['Username'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
