...
<html>
<head>
	<title>Pledge Provided - Secure Prime Investment</title>
                        	...
                        	<div class="dataTable_wrapper table-responsive">
                                <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $sql = "SELECT * FROM matching WHERE PledgeNo IN (SELECT SN FROM helprequest WHERE Matched = '1') ORDER BY ConfirmationDate DESC ";
                                        $result = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $sql_plege_amt = "SELECT * FROM helprequest WHERE SN = '".$row['PledgeNo']."' ";
                                            $result_plege_amt = mysqli_query($conn, $sql_plege_amt);
                                            $row_plege_amt = mysqli_fetch_assoc($result_plege_amt);
                                        ?>
                                        <tr>
                                            <td><?php echo "" . $row['SN'] . ""; ?></td>
                                            <td><?php echo "" . $row['PledgeNo'] . ""; ?></td>
                                            <td><?php echo "" . $row_plege_amt['Username'] . ""; ?></td>
                                            <td><?php echo "CFA " . number_format($row_plege_amt['Amount'], 2, '.', ',') . ""; ?></td>
                                            <td><?php echo "" . $row['MatchTo'] . ""; ?></td>
                                            <?php
                                            ...
                                            if ($date > $row['LastDateToPay']) { ?>
                                                <td style="color: red;"><?php echo "" . $row['LastDateToPay'] . ""; ?></td>
                                            <?php }else { ?>
                                                <td style="color: blue;"><?php echo "" . $row['LastDateToPay'] . ""; ?></td>
                                            <?php } ?>
                                                        
                                            <?php
                                            if (empty($row['Proof'])) { ?>
                                                <td style="color: red;">No proof..</td>
                                                <td style="color: red;"><?php echo "" . $row['ConfirmationDate'] . ""; ?></td>
                                            <?php }else { ?>
                                                <td>
                                                    <a href="#proofModal" data-toggle="modal" data-target="#proofModal<?php echo "" . $row['SN'] . ""; ?>"><img src="/projectnameplus/member/<?= $row['Proof'] ?>" class="table-user-thumb" alt=""></a>
                                                                
                                                </td>
                                                <td style="color: blue;"><?php echo "" . $row['ConfirmationDate'] . ""; ?></td>
                                            <?php } ?>

                                            <?php
                                                if (empty($row['ConfirmationDate'])) { ?>
                                                <td>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#blockModal<?php echo "" . $row['SN'] . ""; ?>">Block</button>
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addtimeModal<?php echo "" . $row['SN'] . ""; ?>">Add Time</button>
                                                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmModal<?php echo "" . $row['SN'] . ""; ?>">Confirm</button>
                                                </td>
                                            <?php }else { ?>
                                                <td>
                                                    <button type="button" disabled class="btn btn-danger" data-toggle="modal" data-target="#unblockModal<?php echo "" . $row['SN'] . ""; ?>">Block</button>
                                                    <button type="button" disabled class="btn btn-warning" data-toggle="modal" data-target="#addtimeModal<?php echo "" . $row['SN'] . ""; ?>">Add Time</button>
                                                    <button type="button" disabled class="btn btn-success" data-toggle="modal" data-target="#confirmModal<?php echo "" . $row['SN'] . ""; ?>">Confirm</button>
                                                </td>
                                            <?php } ?>
                                            </tr>
                                                    ...
                                                    <div class="modal fade" id="proofModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="proofModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Validate proof and perform appropriate actions</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <img style="width: 100%;" src="/projectnameplus/member/<?= $row['Proof'] ?>">
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCEL</button>
                                                                    <?php
                                                                    if (empty($row['ConfirmationDate'])) { ?>
                                                                    <a href="block.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>&sn=<?php echo "" . $row_plege_amt['SN'] . ""; ?>"><button type="button" class="btn btn-danger">BLOCK</button></a>
                                                                    <a href="confirm.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&pledgeno0=<?php echo "" . $row['MatchToNo'] . ""; ?>&pledgeno1=<?php echo "" . $row['PledgeNo'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>"><button type="button" class="btn btn-primary">CONFIRM</button></a>
                                                                    <?php }else { ?>
                                                                    <a href="block.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>&sn=<?php echo "" . $row_plege_amt['SN'] . ""; ?>"><button disabled type="button" class="btn btn-danger">BLOCK</button></a>
                                                                    <a href="confirm.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&pledgeno0=<?php echo "" . $row['MatchToNo'] . ""; ?>&pledgeno1=<?php echo "" . $row['PledgeNo'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>"><button disabled type="button" class="btn btn-primary">CONFIRM</button></a>
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="blockModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="blockModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Block user account and delete matching</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to block the account of <strong><?php echo "" . $row_plege_amt['Username'] . ""; ?></strong> and delete matching of <strong><?php echo "CFA " . number_format($row_plege_amt['Amount'], 2, '.', ',') . ""; ?> </strong> to <strong> <?php echo "" . $row['MatchTo'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="block.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>&sn=<?php echo "" . $row_plege_amt['SN'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="modal fade" id="addtimeModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="addtimeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form class="forms-sample" action="addtime.php?id=<?php echo "" . $row['SN'] . ""; ?>" method="POST">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="demoModalLabel">Add time</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <input type="number" name="hours" min="0" max="10" class="form-control" required placeholder="Enter the number of hours you want to add">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCEL</button>
                                                                        <button type="submit" name="submit" class="btn btn-primary">ADD</button></a>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    ...
                                                    <div class="modal fade" id="confirmModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Confirm payment and make user eligible for receiving help</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-success">
                                                                        Are you sure you want to confirm payment of <strong><?php echo "CFA " . number_format($row_plege_amt['Amount'], 2, '.', ',') . ""; ?> </strong> to <strong><?php echo "" . $row['MatchTo'] . ""; ?></strong> by <strong><?php echo "" . $row_plege_amt['Username'] . ""; ?></strong> and make <strong><?php echo "" . $row_plege_amt['Username'] . ""; ?></strong> eligible to receive <strong><?php echo "CFA " . number_format($row_plege_amt['Amount']*2, 2, '.', ',') . ""; ?></strong> in <strong>5 days?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="confirm.php?user=<?php echo "" . $row_plege_amt['Username'] . ""; ?>&id=<?php echo "" . $row['SN'] . ""; ?>&pledgeno0=<?php echo "" . $row['MatchToNo'] . ""; ?>&pledgeno1=<?php echo "" . $row['PledgeNo'] . ""; ?>&amount0=<?php echo "" . $row_plege_amt['Amount'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
