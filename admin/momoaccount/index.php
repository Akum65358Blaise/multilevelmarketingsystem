...
<html>
<head>
	<title>Mobile Money Accounts - Secure Prime Investment</title>
                                ...
                                <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo "" . $row['MomoCarrier'] . ""; ?></td>
                                            <td><?php echo "" . $row['MomoName'] . ""; ?></td>
                                            <td><?php echo "" . $row['MomoNumber'] . ""; ?></td>
