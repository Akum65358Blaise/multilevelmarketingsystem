                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-yellow">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_helprequest_unmatch_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Unmatched Pledge
                                        </p>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-purple">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_helprequest_match_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Matched Pledge
                                        </p>
