...
if (isset($_POST['submit'])) {
    ...
    //Check contrainst
    //Amount
    $sql0 = "SELECT * FROM package WHERE Amount = '$amount' ";
    $result0 = mysqli_query($conn, $sql0);
    $count0 = mysqli_num_rows($result0);
    if ($count0 == 0) {
        //Username
        $sql1 = "INSERT INTO package (Amount, Active, Date) VALUES ('$amount', '$visibility', '$date')";
        $result1 = mysqli_query($conn, $sql1) or die(mysqli_error($conn));
        if ($result1) {
            $mgs_add_success =  "Successful added the package";
        }else{
            $mgs_add_error =  "Failed to add the package. Please try again later";
        }
    }else{
        $mgs_add_error =  "Help package amount already exits!";
    }
}
...
<html>
<head>
	<title>Pledge Packages - Secure Prime Investment</title>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <form class="forms-sample" action="index.php" method="POST">
                                <?php
                                if (isset($mgs_add_error)) { ?>
                                    <div class="alert alert-danger" role="alert">
                                        <?php echo "" . $mgs_add_error . ""; ?>
                                    </div>
                                <?php } ?>
                                <?php
                                if (isset($mgs_add_success)) { ?>
                                    <div class="alert alert-success" role="alert">
                                        <?php echo "" . $mgs_add_success . ""; ?>
                                    </div>
                                <?php } ?>
                                <div class="row">
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="form-group">
                                            <input type="number" name="amount" required class="form-control" id="exampleInputUsername2" placeholder="Package Amount">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4 col-sm-4">
                                        <div class="form-group">
                                            <select class="form-control" id="exampleSelectGender" name="visibility" required>
                                    ...
                                    <div  class="col-md-4 col-lg-4 col-sm-4">
                                        <button type="submit" name="submit" class="form-control bg-purple btn btn btn-info"><i class="ik ik-plus-circle"></i>ADD NOW</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        	...
                        	<div class="dataTable_wrapper table-responsive">
                                <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $sql = "SELECT * FROM package ORDER BY Amount";
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            if ($row['Active'] == 1) { ?>
                                                <td style="color: blue;">Visible</td>
                                            ...
                                            if ($row['Active'] == 1) { ?>
                                            <td>
                                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hideModal<?php echo "" . $row['SN'] . ""; ?>">Hide</button>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal<?php echo "" . $row['SN'] . ""; ?>">Edit</button>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#deleteModal<?php echo "" . $row['SN'] . ""; ?>">Delete</button>
                                                            </td>
                                            <?php }elseif ($row['Active'] == 0) { ?>
                                            <td>
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#showModal<?php echo "" . $row['SN'] . ""; ?>">Show</button>
                                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal<?php echo "" . $row['SN'] . ""; ?>">Edit</button>
                                                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#deleteModal<?php echo "" . $row['SN'] . ""; ?>">Delete</button>
                                            </td>
                                            <?php } ?>
                                                    ...
                                                    <div class="modal fade" id="hideModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="hideModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Make help package hidden</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to hide this help package: <strong><?php echo "CFA " . number_format($row['Amount'], 2, '.', ',') . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="hide.php?id=<?php echo "" . $row['SN'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="modal fade" id="showModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Make help package visible</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-success">
                                                                        Are you sure you want to show this help package: <strong><?php echo "CFA " . number_format($row['Amount'], 2, '.', ',') . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                                    <a href="show.php?id=<?php echo "" . $row['SN'] . ""; ?>"><button type="button" class="btn btn-primary">YES</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="modal fade" id="editModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form class="forms-sample" action="edit.php?id=<?php echo "" . $row['SN'] . ""; ?>" method="POST">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="demoModalLabel">Edit help package</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-6 col-lg-6 col-sm-6">
                                                                                <div class="form-group">
                                                                                    <input type="number" name="amount" required class="form-control" id="exampleInputUsername2" value="<?php echo "" . $row['Amount'] . ""; ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6 col-lg-6 col-sm-6">
                                                                                <div class="form-group">
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Delete help package</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to delete this help package: <strong><?php echo "CFA " . number_format($row['Amount'], 2, '.', ',') . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
