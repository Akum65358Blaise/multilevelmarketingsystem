...
if (isset($_POST['submit'])) {
    ...
    //Check contrainst
    //News
    $sql0 = "SELECT * FROM news WHERE News = '$news' ";
    $result0 = mysqli_query($conn, $sql0);
    $count0 = mysqli_num_rows($result0);
    if ($count0 == 0) {
        $sql1 = "INSERT INTO news (News, Active, Date) VALUES ('$news', '$visibility', '$date')";
        ...
        if ($result1) {
            ...
            $mgs_add_success =  "Successful published the news on members dashboard";
        }else{
            $mgs_add_error =  "Failed to publish news. Please try again later";
        }
    }else{
        $mgs_add_error =  "Message to publish on member dashboard already exits! You can set this news as show to publish it";
    }
}
...
<html>
<head>
	<title>Publish News - Secure Prime Investment</title>
                                            ...
                                            <?php } ?>
                                                    ...
                                                    <div class="modal fade" id="hideModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="hideModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Make message hidden</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to hide this message: <strong><?php echo "" . $row['News'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                    ...
                                                    <div class="modal fade" id="showModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Make message visible</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-primary">
                                                                        Are you sure you want to show this message: <strong><?php echo "" . $row['News'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
                                                    ...
                                                    <div class="modal fade" id="editModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <form class="forms-sample" action="edit.php?id=<?php echo "" . $row['SN'] . ""; ?>" method="POST">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="demoModalLabel">Edit message</h5>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <textarea name="news" rows="3" class="form-control" id="exampleInputUsername2" value="<?php echo "" . $row['News'] . ""; ?>" placeholder="<?php echo "" . $row['News'] . ""; ?>"></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12 col-lg-12 col-sm-12">
                                                                                <div class="form-group">
                                                                                    <select class="form-control" id="exampleSelectGender" name="visibility">
                                                                                        <?php
                                                                                        if ($row['Active'] == 1) { ?>
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?php echo "" . $row['SN'] . ""; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="demoModalLabel">Delete message</h5>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="alert alert-danger">
                                                                        Are you sure you want to delete this help messahe: <strong><?php echo "" . $row['News'] . ""; ?>?</strong>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">NO</button>
