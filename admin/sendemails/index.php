...
if (isset($_POST['submit'])) {
    ...
    $headers = 'From: Secure Prime Investment Investment donotreply@secureprimeinvestment.com' . "\r\n" . 
                'Reply-To: info@secureprimeinvestment.com' . "\r\n" .
                'Content-type: text/html; charset=iso-8859-1';

    if ($_POST['member'] == 'All Members') {
        $sql = "SELECT * FROM members ";
        $result = mysqli_query($conn, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
            $member = $row['Email'];
            if (mail($member, $subject, $message, $headers)) {
                $mgs_add_success =  "Email successful sent";
            }else{
                $mgs_add_error =  "Failed to send email. Please try again later";
            }
        }
    }else{
        if (mail($member, $subject, $message, $headers)) {
...
<html>
<head>
	<title>Send Email - Secure Prime Investment</title>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <?php } ?>
                                <div class="row">
                                    <div class="col-md-6 col-lg-6 col-sm-6">
                                        <div class="form-group">
                                            <select class="form-control" id="exampleSelectGender" name="member" required>
                                                ...
                                                <option value="<?php echo "" . $row_members['Email'] . ""; ?>"><?php echo "" . $row_members['Username'] . ""; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div  class="col-md-12 col-lg-12 col-sm-12">
                                        <button type="submit" name="submit" class="form-control bg-purple btn btn btn-info"><i class="ik ik-send"></i>SEND EMAIL</button>
                                    </div>
                                </div>
                            </form>
                        </div>
