                        	...
                        	<div class="dataTable_wrapper table-responsive">
                                <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        $sql = "SELECT * FROM helpreceived WHERE AmountReceived != '0' AND MatchingNo IN (SELECT SN FROM matching WHERE Status = 'Paid' AND ConfirmationDate IS NOT NULL) AND PledgeNo IN (SELECT SN FROM helprequest) ORDER BY LastDateToReceive DESC";
                                        ...
                                        <tr>
                                            ...
                                            if ($date > $row['LastDateToReceive']) { ?>
                                                <td style="height: 30px;" scope="row"><span style="color: red;"><strong><?php echo "" . $row['LastDateToReceive'] . ""; ?></strong></span></td>
                                            <?php }else { ?>
                                                <td style="height: 30px;" scope="row"><span style="color: blue;"><strong><?php echo "" . $row['LastDateToReceive'] . ""; ?></strong></span></td>
                                            <?php } ?>
                                        </tr>
                                        <?php }?>
                                    </tbody>
