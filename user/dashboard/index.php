...
if (isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO helprequest (SN, Username, Amount, PledgeDate) VALUES ('$sn', '$id', '$amount', '$date') ";
    $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
    if ($result) {
        $mgs_pledge_success = "Your help request was successfully received. We will notify you by email once you have been matched. <br> However login to your account as frequently as you can should incase there is a delay in the email";
    }else{
        $mgs_pledge_error = "Failed to submit your help request, please try again";
    }
}
...
<head>
    ...
    <title>Dashboard - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="/SecurePrimeInvestment/user/dashboard/"><i class="fa fa-dashboard"></i>DASHBOARD</a>
                    </li>
                    <li>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <?php
                                        if ($count_news == 0) { ?>
                                            <h3 style="color: red; text-transform: uppercase;">no news!!!</h3>
                                        <?php }else{ ?>
                                            <h3 style="color: blue; text-transform: uppercase;"><marquee><?php echo "" . $row_news['News'] . ""; ?>!!!</marquee></h3>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="card-body">
                                                <form class="forms-sample" action="index.php" method="POST">
                                                    <?php
                                                    if (isset($mgs_pledge_error)) { ?>
                                                        <div class="alert alert-danger" role="alert">
                                                            <?php echo "" . $mgs_pledge_error . ""; ?>
                                                        </div>
                                                    <?php } ?>
                                                    <?php
                                                    if (isset($mgs_pledge_success)) { ?>
                                                        <div class="alert alert-success" role="alert">
                                                            <?php echo "" . $mgs_pledge_success . ""; ?>
                                                        </div>
                                                    <?php } ?>
                                                    <div class="form-group">
                                                        <label for="exampleSelectGender">Amount</label>
                                                        <select class="form-control" id="exampleSelectGender" name="amount" required>
                                                            <option value="" selected disabled hidden>Select amount</option>
                                                            <?php
                                                            $sql_package = "SELECT * FROM package WHERE Active = '1' ";
                                                            $result_package = mysqli_query($conn, $sql_package);
                                                            while ($row_package = mysqli_fetch_assoc($result_package)) { ?>
                                                            <option value="<?php echo "" . $row_package['Amount'] . ""; ?>">CFA <?php echo "" . number_format($row_package['Amount'], 2, '.', ',') . ""; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <button type="submit" name="submit" class="btn btn-info"><i class="ik ik-check-circle"></i>Pledge Now</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <div class="widget">
                                    <div class="widget-body">
                                        ...
                                        <div class="text">
                                            <?php
                                            if ($count_total == 0) { ?>
                                                <p style="color: red;">You have no pending financial transactions. Please pledge to provide help to someone to get started.</p>
                                            <?php }else{ ?>
                                                <div>
                                                    <p>Here are your most recent pending financial transactions:</p>
                                                    <p style="color: blue;">
                                                        You are to receive <strong><?php echo "" . $count_toreceive . ""; ?></strong> help . Please scroll down to obtain more information. <br> 
                                                        You have <strong><?php echo "" . $count_matched . ""; ?></strong> dued payment (to receive help). Please scroll down to obtain more information. <br> 
                                                        You have <strong><?php echo "" . $count_matching . ""; ?></strong> matched payment (to provide help). Please scroll down to obtain more information. <br> 
                                                        You have <strong><?php echo "" . $count_pledge . ""; ?></strong> unmatched help request (to provide help). Please scroll down to obtain more information. <br>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-yellow">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_unmatch_helprequest_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-purple">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_match_helprequest_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Matched Pledge
                                        </p>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-green">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_helppaid_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Pledge Paid
                                        </p>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-aqua">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_helptoreceive_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        To Receive
                                        </p>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-red">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_helpreceived_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Received
                                        </p>
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-fuchsia">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_referalbonus_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Referal Bonus
                                        </p>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-sm-12">
                                <div class="small-box bg-orange">
                                    <div class="inner">
                                        <h3>
                                            <?php echo "CFA " . number_format($total_bonus_amt, 2, '.', ',') . ""; ?>
                                        </h3>
                                        <p style="font-weight: bolder; color: white;">
                                        Bonus Money
                                        </p>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-xs-12">
                                <div class="small-box">
                                    <div class="inner">
                                        <h3>
                                            Referal/Sponsor Link
                                        </h3>
                                        <div class="form-group col-lg-12 col-md-12">
                                            <input type="text" class="form-control" id="exampleInputTitle" value="https://www.projectnameplus.com/signup.php?id=<?php echo "" . $myreferalid . ""; ?>">
                                        </div>
                                        <p style="font-weight: bolder;">
                                            Copy and share this link to friends and new members or give them the name <strong><?php echo "" . $myreferalid . ""; ?></strong> to use as referal id when creating an account to gain more profits
                                        </p>
                                    </div>
                                </div>
                            </div>
