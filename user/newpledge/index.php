...
<head>
    ...
    <title>Make New Pledge - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="/SecurePrimeInvestment/user/newpledge/"><i class="fa fa-plus"></i>MAKE NEW PLEDGE</a>
                    </li>
                    <li>
                                ...
                                <div class="card">
                                    <div class="card-body"> 
                                        <form class="forms-sample" action="index.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="submit" class="form-control btn btn-info bg-orange">Pledge Now</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
