...
<head>
    ...
    <title>List of Pledge Received - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a  class="active-menu" href="/SecurePrimeInvestment/user/pledgereceived/"><i class="fa fa-list"></i> LIST OF PLEDGE RECEIVED</a>
                    </li>
                    <li>
                                            ...
                                            <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Balance</th>
                                                        <th>Last Date to Receive</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $sql_help_received = "SELECT * FROM helpreceived WHERE AmountReceived != '0' AND MatchingNo IN (SELECT SN FROM matching WHERE Status = 'Paid' AND ConfirmationDate IS NOT NULL) AND PledgeNo IN (SELECT SN FROM helprequest WHERE Username = '".$_SESSION['name_member']."') ORDER BY LastDateToReceive DESC ";
