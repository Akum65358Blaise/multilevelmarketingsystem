...
<head>
    ...
    <title>My Downlines - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  class="active-menu" href="/SecurePrimeInvestment/user/downlines/"><i class="fa fa-arrow-down"></i> MY DOWNLINES</a>
                    </li>
                    <li>
                                        ...
                                        <div class="dataTable_wrapper table-responsive">
                                            <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $i = 1;
                                                    $sql = "SELECT * FROM members WHERE ReferalID = '".$_SESSION['name_member']."' ";
                                                    $result = mysqli_query($conn, $sql);
