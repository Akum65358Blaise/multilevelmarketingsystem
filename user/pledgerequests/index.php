...
<head>
    ...
    <title>List of Pledge Requests - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="/SecurePrimeInvestment/user/pledgerequests/"><i class="fa fa-list"></i>LIST OF PLEDGE REQUESTS</a>
                    </li>
                    <li>
                                    ...
                                    <div class="card-body p-0 table-border-style">
                                        <div class="dataTable_wrapper table-responsive">
                                            <table border="0" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $sql_help_request = "SELECT * FROM helprequest WHERE Username = '".$_SESSION['name_member']."' ORDER BY PledgeDate DESC ";
                                                    $result_help_request = mysqli_query($conn, $sql_help_request);
                                                    while ($row_help_request = mysqli_fetch_assoc($result_help_request)) { ?>
                                                    <tr>
                                                        <th scope="row"><?php echo "" . $row_help_request['SN'] . ""; ?></th>
                                                        <th scope="row"><?php echo "CFA " . number_format($row_help_request['Amount'], 2, '.', ',') . ""; ?></th>
                                                        <th scope="row"><?php echo "" . $row_help_request['PledgeDate'] . ""; ?></th>
                                                        <?php
                                                        if (empty($row_help_request['Matched']) || $row_help_request['Matched'] == '0') { ?>
                                                            <th scope="row"><span style="color: red;"><strong>Pending...</strong></span></th>
                                                        <?php }elseif ($row_help_request['Matched'] == '1') { ?>
                                                            <th scope="row"><span style="color: blue;"><strong>Matched...</strong></span></th>
                                                        <?php } ?>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
