...
<head>
    ...
    <title>Investment Record - Secure Prime Investment</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  class="active-menu" href="/SecurePrimeInvestment/user/investmentrecord/"><i class="fa fa-file"></i> INVESTMENT RECORD</a>
                    </li>
                    <li>
